...
export RAMFS_SOURCE=`readlink -f $KERNELDIR/initramfsi9152`
export PARENT_DIR=`readlink -f ..`
export USE_SEC_FIPS_MODE=true
export CROSS_COMPILE=/home/kar/toolchain2/bin/arm-eabi-
export KBUILD_BUILD_VERSION="1"
export BUILD_VERSION="K2wl-SGM9152-v1.0.0"
...
./mkbootimg --kernel $KERNELDIR/arch/arm/boot/zImage --ramdisk $RAMFS_TMP.cpio.gz --board crater --base 0xa2000000 --pagesize 4096 -o $KERNELDIR/boot.img
